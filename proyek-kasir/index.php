      ...
      <main>
        <div class="container pt-3">
          <div class="col-md-7 mx-auto col-lg-5 offset-lg-4 offset-md-3 text-center hijauTua mt-4 bg-opacity-75 rounded-3 shadow-lg pb-2 pt-2">
            <h1 class="display-6 text-light"><i class="fa-solid fa-store"></i><br> Masuk ke Kasir Go</h1>
            <div class="bg-white p-5 border shadow m-3 rounded-3">
              ...
              <form action="<?= "prosesLogin.php?aksi=login"; ?>" method="POST">
                ...
                <button type="submit" class="btn w-100 my-9 shadow">Login <i class="fa-solid fa-fw fa-right-to-bracket"></i></button>
              </form>
              <!-- Login Form -->
            </div>
          </div>
