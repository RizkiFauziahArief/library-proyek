...
<nav class="sb-topnav navbar navbar-expand navbar-dark hijauTua">
  ...
  <!-- Navbar Brand-->
  <a class="navbar-brand ps-3" href="index.php"><i class="fa-solid fa-store"></i> Kasir Go</a>
    ...
    <nav class="sb-sidenav accordion bg-light shadow" id="sidenavAccordion">
      <div class="sb-sidenav-menu">
        <div class="nav">
          ...
          <a class="nav-link hijauText" href="index.php" style="color: #426777;">
            <div class="sb-nav-link-icon hijauText"><i class="fa-solid fa-fw fa-gauge hijauText"></i></div>
            Dashboard
          </a>
          <a class="nav-link collapsed hijauText" style="color: #426777;" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
          ...
          <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
            <nav class="sb-sidenav-menu-nested nav">
              <a class="nav-link hijauText" style="color: #426777;" href="dataBarang.php">Produk</a>
              <a class="nav-link hijauText" style="color: #426777;" href="dataKategori.php">Kategori & Satuan</a>
            </nav>
          </div>
          <a class="nav-link collapsed hijauText" style="color: #426777;" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts3" aria-expanded="false" aria-controls="collapseLayouts">
          ...
          <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
            <nav class="sb-sidenav-menu-nested nav">
              <a class="nav-link hijauText" style="color: #426777;" href="lapPenjualan.php">
                Penjualan
              </a>
              <a class="nav-link hijauText" style="color: #426777;" href="lapPembelian.php">
                Pembelian
              </a>
            </nav>
          </div>
          <a class="nav-link hijauText" style="color: #426777;" href="dataPenjualan.php">
            <div class="sb-nav-link-icon hijauText"><i class="fa-solid fa-fw fa-cart-shopping"></i></div>
            Kasir
          </a>
          <a class="nav-link hijauText" style="color: #426777;" href="dataUser.php">
          ...
          <a class="nav-link hijauText" style="color: #426777;" href="userAdmin.php">
            <div class="sb-nav-link-icon hijauText"><i class="fa-solid fa-fw fa-gear"></i></div>
            Pengaturan User
          </a>
          <a class="nav-link hijauText" style="color: #426777;" onclick="javascript: return confirm('Apakah Anda yakin ingin keluar dari sistem?')" href="<?= "../prosesLogin.php?aksi=logout"; ?>">
