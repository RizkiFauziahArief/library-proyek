          ...
          <div class="row mb-2 mx-2">
              ...
              <div class="card">
                <a href="dataBarang.php" class="text-dark">
                  <div class="card-body shadow">
                    <h5 class="card-title"><i class="fa-solid fa-fw fa-boxes-stacked text-success"></i> Daftar Menu</h5>
            ...
            <div class="col-sm-4 p-1">
              <a href="dataBarang.php" class="text-dark">
                <div class="card">
                  <div class="card-body shadow">
                    <h5 class="card-title"><i class="fa-solid fa-box-open text-success"></i> Stok</h5>
          ...
          <div class="row mb-5 mx-2">
            <div class="col-sm-4 p-1">
              <a href="lapPenjualan.php" class="text-dark">
                <div class="card">
                  <div class="card-body shadow">
                    <h5 class="card-title"><i class="fa-solid fa-money-bills text-success"></i> Laporan Penjualan</h5>
      ...
      <footer class="py-3 bg-light mt-auto">
        <div class="container-fluid px-4">
          <div class="d-flex align-items-center justify-content-between small">
            <div class="text-muted">Copyright &copy; Fakultas Teknologi Informasi 2022</div>
          </div>
        </div>
      </footer>
    </div>
