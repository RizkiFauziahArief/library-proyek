...
<body onload="javascript:window.print()" style="margin: 0 auto; width: 1000px">
  ...
  <table align="center" width="90%" cellpadding="0" cellspacing="0">
    <tr>
      <td>
        <div align="center">
          <font size="8"><b>Angkringan Go</b></font>
        </div>
      </td>
    </tr>
    <tr>
      <td>
        <div align="center">
          <font size="3">Jalan Raya Wado - Sumedang</font>
        </div>
      </td>
    </tr>
  </table><br>
  ...
  <table align="right" cellpadding="0" cellspacing="0">
    <tr>
      <td>
        <center>Sumedang, <?= $db->tgl_indo(date('Y-m-d')); ?></center>
      </td>
    </tr>
    <tr>
      <td>
        <center>Direktur Angkringan</center>
        <p align="center">
          <img src="../img/ttdLapBrg.jpeg" width="30%">
        </p>
        <center><u>Pemilik Angkringan</u></center>
      </td>
    </tr>
  </table>
